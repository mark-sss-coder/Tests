...
elements={'Welcome to conway\'s game of life!':{color:'c8c8c8',category: 'land',density: 1000,tick(block){pixelMap[block.x][block.y]=null;},alive:{color:'#cecece',category: 'land',density: 1000,tick({x,y}){
 let neigh=0;
...
}},dead:{color:'989898',category: 'land',density: 1000,tick({x,y}){
 let neigh=0;
 for(const [xPos,yPos,weight,deadWeight] of lifeRules.neighbors) {
